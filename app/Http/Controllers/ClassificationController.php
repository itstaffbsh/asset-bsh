...
class ClassificationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('classifications.index')->with('success', 'Klasifikasi berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, Classification $classification)
    {
        ...
        return redirect()->route('classifications.index')->with('success', 'Klasifikasi berhasil diupdate.');
    }

    public function destroy(Classification $classification)
    {
        $classification->delete();
        return redirect()->route('classifications.index')->with('success', 'Klasifikasi berhasil dihapus.');
    }
}
