...
class AsetController extends Controller
{
    ...
    */
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('products.index')->with('success', 'Aset berhasil diperbarui.');
    }
    ...
    */
    public function destroy(Request $request, $id)
    {
        ...
        $product->delete();
        return redirect()->route('products.index')->with('success', 'Aset dipindahkan ke sampah.');
    }
    ...
    */
    public function restore($id)
    {
        ...
        return redirect()->route('products.trash')->with('success', 'Aset dikembalikan.');
    }
    ...
    */
    public function forceDelete($id)
    {
        ...
        $product->forceDelete();
        return redirect()->route('products.trash')->with('success', 'Aset dihapus permanen.');
    }
    ...
    */
    public function updateHistory(Request $request, ProductHistory $productHistory)
    {
        ...
        return redirect()->route('products.show', $productHistory->product_id)->with('success', 'Riwayat diupdate.');
    }
    ...
    */
    public function cancelHistory(ProductHistory $productHistory)
    {
        ...
        return back()->with('success', 'Riwayat dibatalkan.');
    }
    ...
    public function quickReturn(ProductHistory $productHistory)
    {
        ...
        if ($latest->id !== $productHistory->id || $latest->jenis_transaksi !== 'meminjam') {
            return response()->json(['success' => false, 'message' => 'Aset ini sudah tidak aktif dipinjam atau sudah dikembalikan.']);
        }
        ...
        return response()->json(['success' => true, 'message' => 'Aset berhasil dikembalikan ke kantor.']);
    }
    ...
    */
    public function storeTransfer(Request $request)
    {
        ...
        // ── MODE MEMINJAM (Batch STTB) ──────────────────────────────────────────
        if ($request->jenis_transaksi === 'meminjam') {
            $request->validate([
            ...
            foreach ($request->product_ids as $index => $productId) {
                ProductHistory::create([
                    ...
                    'pihak_pertama_id' => $request->pihak_pertama_id,
                    'tanggal_pinjam'   => $tanggal,
                ]);
            }

            // Redirect ke halaman STTB yang siap cetak
            return redirect()->route('sttb.show', $batchId)
                ->with('success', 'Peminjaman berhasil! STTB sudah siap dicetak.');
        }
        ...
        return redirect()->route('products.kembali')->with('success', 'Aset berhasil dikembalikan ke kantor.');
    }
    ...
    */
    public function showSttb($batchId)
    {
        ...
        return view('products.sttb', compact('histories', 'pihakPertama', 'pihakKedua', 'tanggal', 'batchId'));
    }
}
