<x-app-layout>
    <x-slot name="header"><h2 class="font-serif text-2xl font-bold text-[#4a554a] leading-tight">{{ __('Edit Aset') }}: {{ $product->description }}</h2></x-slot>
                ...
                <div class="space-y-6">
                    <div class="bg-white rounded-xl shadow-sm border border-[#e5e0d8] p-6">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="classification_id" id="classification_id" class="w-full" required>
                                ...
                                @foreach($classifications as $c)
                                    <option value="{{ $c->id }}" {{ (old('classification_id') ?? $product->classification_id) == $c->id ? 'selected' : '' }}>{{ $c->nama_klasifikasi }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="description" value="{{ old('description', $product->description) }}" class="w-full border-[#d1cdba] rounded-md shadow-sm focus:border-[#a47b53]" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="department_id" id="department_id" class="w-full" required>
                                ...
                                @foreach($departments as $d)
                                    <option value="{{ $d->id }}" data-kode="{{ $d->kode_asset }}" {{ (old('department_id') ?? $product->department_id) == $d->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <input type="text" name="nomor_unik" id="nomor_unik" value="{{ old('nomor_unik', $product->nomor_unik) }}" class="flex-1 border-[#d1cdba] rounded-r-md shadow-sm focus:border-[#a47b53]" required>
                            </div>
                        </div>

                        <div>
                            <label class="block text-xs font-bold text-[#5c6b5b] uppercase tracking-widest mb-2">{{ __('Harga Perolehan (Rp)') }}</label>
                            <input type="text" name="harga" id="harga" value="{{ old('harga', number_format($product->harga, 0, ',', '.')) }}" class="w-full border-[#d1cdba] rounded-md shadow-sm focus:border-[#a47b53]">
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-[#e5e0d8] p-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="serial_number" value="{{ old('serial_number', $product->serial_number) }}" class="w-full border-[#d1cdba] rounded-md shadow-sm focus:border-[#a47b53]">
                        </div>
                        <div class="mb-4">
                            <label class="block text-xs font-bold text-[#5c6b5b] uppercase tracking-widest mb-2">{{ __('IMEI') }}</label>
                            <input type="text" name="imei" value="{{ old('imei', $product->imei) }}" class="w-full border-[#d1cdba] rounded-md shadow-sm focus:border-[#a47b53]">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-[#5c6b5b] uppercase tracking-widest mb-2">{{ __('MAC Address') }}</label>
                            <input type="text" name="mac_address" value="{{ old('mac_address', $product->mac_address) }}" class="w-full border-[#d1cdba] rounded-md shadow-sm focus:border-[#a47b53]">
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <div class="bg-white rounded-xl shadow-sm border border-[#e5e0d8] p-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="processor" value="{{ old('processor', $product->processor) }}" class="w-full border-[#d1cdba] rounded-md shadow-sm focus:border-[#a47b53]">
                        </div>

                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                <label class="block text-xs font-bold text-[#5c6b5b] uppercase tracking-widest mb-2">{{ __('RAM Bawaan') }}</label>
                                <input type="text" name="ram" value="{{ old('ram', $product->ram) }}" class="w-full border-[#d1cdba] rounded-md shadow-sm focus:border-[#a47b53]">
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-[#5c6b5b] uppercase tracking-widest mb-2">{{ __('RAM Baru') }}</label>
                                <input type="text" name="new_ram" value="{{ old('new_ram', $product->new_ram) }}" class="w-full border-[#d1cdba] rounded-md shadow-sm focus:border-[#a47b53]">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" name="ssd" value="{{ old('ssd', $product->ssd) }}" class="w-full border-[#d1cdba] rounded-md shadow-sm focus:border-[#a47b53]">
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-[#5c6b5b] uppercase tracking-widest mb-2">{{ __('SSD Baru') }}</label>
                                <input type="text" name="new_ssd" value="{{ old('new_ssd', $product->new_ssd) }}" class="w-full border-[#d1cdba] rounded-md shadow-sm focus:border-[#a47b53]">
                            </div>
                        </div>

                        <div class="mb-4">
                            <label class="block text-xs font-bold text-[#5c6b5b] uppercase tracking-widest mb-2">{{ __('Operating System (OS)') }}</label>
                            <input type="text" name="os" value="{{ old('os', $product->os) }}" class="w-full border-[#d1cdba] rounded-md shadow-sm focus:border-[#a47b53]">
                        </div>

                        <div class="mb-4">
                            <label class="block text-xs font-bold text-[#5c6b5b] uppercase tracking-widest mb-2">{{ __('Screen ID') }}</label>
                            <input type="text" name="screen_id" value="{{ old('screen_id', $product->screen_id) }}" class="w-full border-[#d1cdba] rounded-md shadow-sm focus:border-[#a47b53]">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="device_class" class="w-full border-[#d1cdba] rounded-md shadow-sm focus:border-[#a47b53]">
                                ...
                                @foreach(\App\Models\Aset::DEVICE_CLASSES as $class)
                                    <option value="{{ $class }}" {{ (old('device_class') ?? $product->device_class) == $class ? 'selected' : '' }}>{{ $class }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4 pt-4">
                        <button type="submit" class="flex-1 bg-[#a47b53] text-white py-3 rounded-xl shadow-lg hover:bg-[#8b6540] transition font-bold text-lg">
                            🔄 {{ __('Perbarui Aset') }}
                        </button>
