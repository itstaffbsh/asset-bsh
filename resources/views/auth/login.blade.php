<x-guest-layout>
    <div class="mb-6 text-center">
        <h2 class="font-serif text-2xl font-bold text-[#4a554a]">{{ __('Selamat Datang') }}</h2>
        <p class="text-gray-500 text-sm mt-1">{{ __('Silakan masuk untuk mengelola aset') }}</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <!-- Email Address -->
        <div class="mb-5">
            <label class="block text-xs font-bold text-[#5c6b5b] uppercase tracking-widest mb-2">{{ __('Email Address') }}</label>
        ...
        <!-- Password -->
        <div class="mb-5">
            <label class="block text-xs font-bold text-[#5c6b5b] uppercase tracking-widest mb-2">{{ __('Password') }}</label>
        ...
        <div class="flex items-center justify-between mb-8">
            <label class="inline-flex items-center">
                ...
                <span class="ms-2 text-xs text-gray-500">{{ __('Ingat saya') }}</span>
            </label>
