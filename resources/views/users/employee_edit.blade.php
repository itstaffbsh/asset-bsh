            ...
            <form action="{{ route('employees.update', $user->id) }}" method="POST" class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="job_position" value="{{ old('job_position', $user->job_position) }}" class="w-full border-[#d1cdba] rounded-lg shadow-sm focus:border-[#a47b53]">
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-[#5c6b5b] mb-1">{{ __('Job Level') }}</label>
                        <input type="text" name="job_level" value="{{ old('job_level', $user->job_level) }}" class="w-full border-[#d1cdba] rounded-lg shadow-sm focus:border-[#a47b53]">
                    </div>
                    <div>
